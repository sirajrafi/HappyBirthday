...
const LoveLetter = () => {
    ...
    const lettersData = [
        ...
        },
        {
            id: 7,
            name: "Siraj",
            msg: " I know that ive been always away from you for studying and working but i promise you that we will always be together and InshaAllah one day, we get to be together forever.",
        },
        {
            id: 8,
            name: "Siraj",
            msg: "Thank you for being my constant source of joy and strength. I love you to the moon and back. <3",
        },
    ];
                ...
                <div className={`envelope ${openEnvelope ? "active" : ""}`}>
                    ...
                    <div className="munna envelope-flap text-black relative">
                        <div className='munna absolute left-1/2 top-[20%] -translate-x-1/2 flex items-center justify-center flex-col md:gap-y-2'>
                            ...
                            <span className='munna font-dancingScript md:text-3xl text-xl'>Dear Ainn Farisya</span>
                        </div>
                    </div>
