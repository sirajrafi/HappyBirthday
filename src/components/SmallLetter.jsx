...
const SmallLetter = () => {
    ...
    <div className="small-rajib-paper-content">
        ...
        <p>My Girl,<br /><br />Happy Birthday again Sayang! Im really proud of you and all the amazing things you do. I will always be your number one supporter. I miss you sayang, nantiiiiiiii kita keluar tau sayang bila i balik nanti. MUAHHHH<br /><br />Siraj</p>
    </div>
