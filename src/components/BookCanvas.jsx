                ...
                <div className="card1">
                    <div className="cover-text-wrapper">
                        <h4 className="username">
                            Dear Ainn Farisya<span className="underline"></span>
                        </h4>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            <article style={{ marginBottom: '8px' }}>Happy Birthday, Sayang ❤️</article>
                            <article style={{ marginBottom: '10px' }}>From the moment we met, I know that you're the one that going to be my forever and since then you are my friend, listener, partner and soon wife hihi ❤️. </article>
                            <article style={{ marginBottom: '10px' }}>On your birthday, I just want you to know that I want you with me in every chapter, every storm, every sunshine, every tomorrow. No matter what comes, I’ll be on your side—always. I’ll choose you, protect you, stand with you, and love you in ways that remind you you’re never alone.</article>
                            <article style={{ marginBottom: '10px' }}>I wish you all the best throughout your life and always be the best version of yourself and goodluck on your Finals sayang. <br />
                                Not to forget, you’re the reason my life feels softer, brighter, and endlessly worth living. Happy Birthday, Mi Amore.</article>
                        </div>
